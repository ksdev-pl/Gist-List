...
App::singleton('GuzzleGithubApi', function() {
    return new GuzzleGithubApi();
});

App::bind('UserController', function($app) {
    return new UserController(App::make('GuzzleGithubApi'));
});

App::bind('GistController', function($app) {
